  ...
  define(['exports', 'aurelia-loader', 'aurelia-pal', 'aurelia-metadata'], function (exports, _aureliaLoader, _aureliaPal, _aureliaMetadata) {
    ...
    var DefaultLoader = exports.DefaultLoader = function (_Loader) {
      ...
      function DefaultLoader() {
        var _this = _possibleConstructorReturn(this || _global, _Loader.call(this || _global));
      ...
      DefaultLoader.prototype.useTemplateLoader = function useTemplateLoader(templateLoader) {
        (this || _global).templateLoader = templateLoader;
      };
      ...
      DefaultLoader.prototype.loadText = function loadText(url) {
        return this._import(this.applyPluginToUrl(url, (this || _global).textPluginName)).then(function (textOrModule) {
    ...
    if (!_aureliaPal.PLATFORM.global.System || !_aureliaPal.PLATFORM.global.System.import) {
      ...
      DefaultLoader.prototype.loadModule = function (id) {
        ...
        var existing = (this || _global).moduleRegistry[id];
