import { dew as _indexDewDew } from "aurelia-history/index.dew.js";
...
export function dew() {
  ...
  var aureliaHistory = _indexDewDew();
  ...
  ***************************************************************************** */
  ...
  var BrowserHistory = function (_super) {
    ...
    BrowserHistory.prototype.activate = function (options) {
      ...
      this._isActive = true;
      var normalizedOptions = this.options = Object.assign({}, {
        root: '/'
