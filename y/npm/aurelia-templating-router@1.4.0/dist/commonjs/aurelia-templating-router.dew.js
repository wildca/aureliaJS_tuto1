import { dew as _indexDewDew } from "aurelia-router/index.dew.js";
import { dew as _indexDew2Dew } from "aurelia-metadata/index.dew.js";
import { dew as _indexDew3Dew } from "aurelia-path/index.dew.js";
import { dew as _indexDew4Dew } from "aurelia-templating/index.dew.js";
import { dew as _indexDew5Dew } from "aurelia-dependency-injection/index.dew.js";
import { dew as _indexDew6Dew } from "aurelia-binding/index.dew.js";
import { dew as _indexDew7Dew } from "aurelia-pal/index.dew.js";
import { dew as _indexDew8Dew } from "aurelia-logging/index.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  var aureliaRouter = _indexDewDew();

  var aureliaMetadata = _indexDew2Dew();

  var aureliaPath = _indexDew3Dew();

  var aureliaTemplating = _indexDew4Dew();

  var aureliaDependencyInjection = _indexDew5Dew();

  var aureliaBinding = _indexDew6Dew();

  var aureliaPal = _indexDew7Dew();

  var LogManager = _indexDew8Dew();
  /*! *****************************************************************************
  ...
  ***************************************************************************** */
  ...
  function () {
    function RouterView(element, container, viewSlot, router, viewLocator, compositionTransaction, compositionEngine) {
      ...
      this.compositionEngine = compositionEngine; // add this <router-view/> to router view ports lookup based on name attribute
      // when this router is the root router-view
      // also trigger AppRouter registerViewPort extra flow

      this.router.registerViewPort(this, this.element.getAttribute('name')); // Each <router-view/> process its instruction as a composition transaction
    ...
    RouterView.prototype.process = function ($viewPortInstruction, waitToSwap) {
      var _this = this; // have strong typings without exposing it in public typings, this is to ensure maximum backward compat
      ...
      childContainer.get(RouterViewLocator)._notify(this); // layoutInstruction is our layout viewModel
    ...
    RouterView.prototype.swap = function ($viewPortInstruction) {
      ...
      var previousView = this.view; // Final step of swapping a <router-view/> ViewPortComponent
      ...
      if (layoutInstruction) {
        ...
        return this.compositionEngine // first create controller from layoutInstruction
