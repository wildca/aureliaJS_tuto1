...
export function dew() {
  ...
  _dewExec = true;
  define('aurelia-router', ['exports', 'aurelia-logging', 'aurelia-dependency-injection', 'aurelia-history', 'aurelia-route-recognizer', 'aurelia-event-aggregator'], function (exports, LogManager, aureliaDependencyInjection, aureliaHistory, aureliaRouteRecognizer, aureliaEventAggregator) {
    'use strict';
    /*! *****************************************************************************
    ...
    ***************************************************************************** */
    ...
    function () {
      function NavigationInstruction(init) {
         ...
         */
        (this || _global).plan = null;
        (this || _global).options = {};
        Object.assign(this || _global, init);
        (this || _global).params = (this || _global).params || {};
        (this || _global).viewPortInstructions = {};
        var ancestorParams = [];
        var current = this || _global;
        ...
        var allParams = Object.assign.apply(Object, [{}, (this || _global).queryParams].concat(ancestorParams));
        (this || _global).lifecycleArgs = [allParams, (this || _global).config, this || _global];
      }
      /**
      ...
      NavigationInstruction.prototype.getAllInstructions = function () {
        var instructions = [this || _global];
        var viewPortInstructions = (this || _global).viewPortInstructions;
      ...
      NavigationInstruction.prototype.addViewPortInstruction = function (nameOrInitOptions, strategy, moduleId, component) {
        ...
        var lifecycleArgs = (this || _global).lifecycleArgs;
        var config = Object.assign({}, lifecycleArgs[1], {
        ...
        return (this || _global).viewPortInstructions[viewPortName] = viewPortInstruction;
      };
      /**
      ...
      NavigationInstruction.prototype.getWildCardName = function () {
        ...
        var configRoute = (this || _global).config.route;
      ...
      NavigationInstruction.prototype.getWildcardPath = function () {
        ...
        var path = (this || _global).params[wildcardName] || '';
        var queryString = (this || _global).queryString;
      ...
      NavigationInstruction.prototype.getBaseUrl = function () {
        ...
        var fragment = decodeURI((this || _global).fragment);

        if (fragment === '') {
          var nonEmptyRoute = (this || _global).router.routes.find(function (route) {
      ...
      NavigationInstruction.prototype._commitChanges = function (waitToSwap) {
        ...
        var router = (this || _global).router;
        router.currentInstruction = this || _global;
        var previousInstruction = (this || _global).previousInstruction;

        if (previousInstruction) {
          previousInstruction.config.navModel.isActive = false;
        }

        (this || _global).config.navModel.isActive = true;
        ...
        var _loop_1 = function (viewPortName) {
          ...
          /* Replace */
              ...
              if (childNavInstruction && childNavInstruction.parentCatchHandler) {
                ...
                loads.push(viewPort.process(viewPortInstruction, waitToSwap).then(function () {
                  return childNavInstruction ? childNavInstruction._commitChanges(waitToSwap) : Promise.resolve();
                }));
              }
            } else {
      ...
      NavigationInstruction.prototype._buildTitle = function (separator) {
        ...
        var title = '';
        var childTitles = [];
        var navModelTitle = (this || _global).config.navModel.title;
        var instructionRouter = (this || _global).router;
        var viewPortInstructions = (this || _global).viewPortInstructions;
    ...
    */
    ...
    function () {
      function NavModel(router, relativeHref) {
        ...
        */
        ...
        (this || _global).relativeHref = null;
        /**
        ...
        */
        ...
        (this || _global).config = null;
        (this || _global).router = router;
        (this || _global).relativeHref = relativeHref;
      }
      /**
      ...
      */
      ...
      NavModel.prototype.setTitle = function (title) {
        (this || _global).title = title;

        if ((this || _global).isActive) {
          (this || _global).router.updateTitle();
        }
      };
    ...
    function () {
      function RouterConfiguration() {
        (this || _global).instructions = [];
        (this || _global).options = {};
        (this || _global).pipelineSteps = [];
      }
      /**
      ...
      RouterConfiguration.prototype.addPipelineStep = function (name, step) {
        ...
        (this || _global).pipelineSteps.push({
          name: name,
          step: step
        });
      ...
      RouterConfiguration.prototype.addAuthorizeStep = function (step) {
        return this.addPipelineStep("authorize"
        /* Authorize */
        , step);
      };
      /**
      ...
      RouterConfiguration.prototype.addPreActivateStep = function (step) {
        return this.addPipelineStep("preActivate"
        /* PreActivate */
        , step);
      };
      /**
      ...
      RouterConfiguration.prototype.addPreRenderStep = function (step) {
        return this.addPipelineStep("preRender"
        /* PreRender */
        , step);
      };
      /**
      ...
      RouterConfiguration.prototype.addPostRenderStep = function (step) {
        return this.addPipelineStep("postRender"
        /* PostRender */
        , step);
      };
      /**
      ...
      RouterConfiguration.prototype.fallbackRoute = function (fragment) {
        (this || _global)._fallbackRoute = fragment;
        return this || _global;
      };
      /**
      ...
      RouterConfiguration.prototype.useViewPortDefaults = function (viewPortConfig) {
        (this || _global).viewPortDefaults = viewPortConfig;
        return this || _global;
      };
      /**
      ...
      RouterConfiguration.prototype.mapRoute = function (config) {
        (this || _global).instructions.push(function (router) {
      ...
      RouterConfiguration.prototype.mapUnknownRoutes = function (config) {
        (this || _global).unknownRouteConfig = config;
        return this || _global;
      };
      /**
      ...
      RouterConfiguration.prototype.exportToRouter = function (router) {
        ...
        var _a = this || _global,
            title = _a.title,
            titleSeparator = _a.titleSeparator,
            unknownRouteConfig = _a.unknownRouteConfig,
            _fallbackRoute = _a._fallbackRoute,
            viewPortDefaults = _a.viewPortDefaults;
        ...
        Object.assign(router.options, (this || _global).options);
        var pipelineSteps = (this || _global).pipelineSteps;
    ...
    function () {
      ...
      function Router(container, history) {
        ...
        (this || _global).transformTitle = function (title) {
          if (_this.parent) {
      ...
      Router.prototype.reset = function () {
        ...
        (this || _global).viewPorts = {};
        (this || _global).routes = [];
        (this || _global).baseUrl = '';
        (this || _global).isConfigured = false;
        (this || _global).isNavigating = false;
        (this || _global).isExplicitNavigation = false;
        (this || _global).isExplicitNavigationBack = false;
        (this || _global).isNavigatingFirst = false;
        (this || _global).isNavigatingNew = false;
        (this || _global).isNavigatingRefresh = false;
        (this || _global).isNavigatingForward = false;
        (this || _global).isNavigatingBack = false;
        (this || _global).couldDeactivate = false;
        (this || _global).navigation = [];
        (this || _global).currentInstruction = null;
        (this || _global).viewPortDefaults = {};
        (this || _global)._fallbackOrder = 100;
        (this || _global)._recognizer = new aureliaRouteRecognizer.RouteRecognizer();
        (this || _global)._childRecognizer = new aureliaRouteRecognizer.RouteRecognizer();
        (this || _global)._configuredPromise = new Promise(function (resolve) {
      ...
      Router.prototype.registerViewPort = function (viewPort, name) {
        name = name || 'default';
        (this || _global).viewPorts[name] = viewPort;
      };
      /**
      ...
      Router.prototype.ensureConfigured = function () {
        return (this || _global)._configuredPromise;
      };
      /**
      ...
      Router.prototype.navigate = function (fragment, options) {
        if (!(this || _global).isConfigured && (this || _global).parent) {
          return (this || _global).parent.navigate(fragment, options);
        }

        (this || _global).isExplicitNavigation = true;
        return (this || _global).history.navigate(_resolveUrl(fragment, (this || _global).baseUrl, (this || _global).history._hasPushState), options);
      };
      /**
      ...
      Router.prototype.navigateBack = function () {
        (this || _global).isExplicitNavigationBack = true;

        (this || _global).history.navigateBack();
      };
      /**
      ...
      Router.prototype.createChild = function (container) {
        var childRouter = new Router(container || (this || _global).container.createChild(), (this || _global).history);
        childRouter.parent = this || _global;
        return childRouter;
      };
      /**
      ...
      Router.prototype.generate = function (nameOrRoute, params, options) {
        ...
        var recognizer = 'childRoute' in params ? (this || _global)._childRecognizer : (this || _global)._recognizer;
        var hasRoute = recognizer.hasRoute(nameOrRoute);

        if (!hasRoute) {
          if ((this || _global).parent) {
            return (this || _global).parent.generate(nameOrRoute, params, options);
          }
        ...
        var rootedPath = _createRootedPath(path, (this || _global).baseUrl, (this || _global).history._hasPushState, options.absolute);

        return options.absolute ? "" + (this || _global).history.getAbsoluteRoot() + rootedPath : rootedPath;
      };
      /**
      ...
      Router.prototype.createNavModel = function (config) {
        var navModel = new NavModel(this || _global, 'href' in config ? config.href // potential error when config.route is a string[] ?
        : config.route);
      ...
      Router.prototype.addRoute = function (config, navModel) {
        if (Array.isArray(config.route)) {
          var routeConfigs = _ensureArrayWithSingleRoutePerConfig(config); // the following is wrong. todo: fix this after TS refactoring release


          routeConfigs.forEach((this || _global).addRoute.bind(this || _global));
          return;
        }
        ...
        (this || _global).routes.push(config);
        ...
        var state = (this || _global)._recognizer.add({
          path: path,
          handler: config,
        ...
        if (path) {
          ...
          (this || _global)._childRecognizer.add({
        ...
        var navigation = (this || _global).navigation;
        ...
        if ((navModel.order || navModel.order === 0) && navigation.indexOf(navModel) === -1) {
          ...
          if (typeof navModel.order !== 'number') {
            navModel.order = ++(this || _global)._fallbackOrder;
          }

          navigation.push(navModel); // this is a potential error / inconsistency between browsers
          //
      ...
      Router.prototype.hasRoute = function (name) {
        return !!((this || _global)._recognizer.hasRoute(name) || (this || _global).parent && (this || _global).parent.hasRoute(name));
      };
      /**
      ...
      Router.prototype.hasOwnRoute = function (name) {
        return (this || _global)._recognizer.hasRoute(name);
      };
      /**
      ...
      Router.prototype.handleUnknownRoutes = function (config) {
        ...
        (this || _global).catchAllHandler = function (instruction) {
          return _this._createRouteConfig(config, instruction).then(function (c) {
      ...
      Router.prototype.updateTitle = function () {
        var parentRouter = (this || _global).parent;

        if (parentRouter) {
          return parentRouter.updateTitle();
        }

        var currentInstruction = (this || _global).currentInstruction;
      ...
      Router.prototype.refreshNavigation = function () {
        var nav = (this || _global).navigation;

        for (var i = 0, length_1 = nav.length; i < length_1; i++) {
          var current = nav[i];

          if (!current.config.href) {
            current.href = _createRootedPath(current.relativeHref, (this || _global).baseUrl, (this || _global).history._hasPushState);
          } else {
            current.href = _normalizeAbsolutePath(current.config.href, (this || _global).history._hasPushState);
          }
        }
      };
      /**
      ...
      Router.prototype.useViewPortDefaults = function ($viewPortDefaults) {
        ...
        for (var viewPortName in viewPortDefaults) {
          ...
          (this || _global).viewPortDefaults[viewPortName] = {
      ...
      Router.prototype._refreshBaseUrl = function () {
        ...
        if (parentRouter) {
          (this || _global).baseUrl = generateBaseUrl(parentRouter, parentRouter.currentInstruction);
        }
      };
      /**@internal */
      ...
      Router.prototype._createNavigationInstruction = function (url, parentInstruction) {
        ...
        var urlRecognizationResults = (this || _global)._recognizer.recognize(url);

        if (!urlRecognizationResults || !urlRecognizationResults.length) {
          urlRecognizationResults = (this || _global)._childRecognizer.recognize(url);
        }
        ...
        var instructionInit = {
          ...
          previousInstruction: (this || _global).currentInstruction,
          router: this || _global,
          options: {
            compareQueryParams: (this || _global).options.compareQueryParams
          }
        };
        var result;
        ...
        if (urlRecognizationResults && urlRecognizationResults.length) {
        ...
        } else if ((this || _global).catchAllHandler) {
          var instruction = new NavigationInstruction(Object.assign({}, instructionInit, {
            params: {
              path: fragment
            },
          ...
          result = evaluateNavigationStrategy(instruction, (this || _global).catchAllHandler);
        } else if ((this || _global).parent) {
          var router = this._parentCatchAllHandler((this || _global).parent);
        ...
        if (result && parentInstruction) {
          (this || _global).baseUrl = generateBaseUrl((this || _global).parent, parentInstruction);
        }
    ...
    function () {
      ...
      Pipeline.prototype.run = function (instruction) {
        var nextFn = createNextFn(instruction, (this || _global).steps);
        return nextFn();
      };
    ...
    */
    ...
    function () {
      ...
      function Redirect(url, options) {
        ...
        (this || _global).shouldContinueProcessing = false;
      }
      /**
      ...
      Redirect.prototype.navigate = function (appRouter) {
        var navigatingRouter = (this || _global).options.useAppRouter ? appRouter : (this || _global).router || appRouter;
        navigatingRouter.navigate((this || _global).url, (this || _global).options);
      };
    ...
    function () {
      ...
      RedirectToRoute.prototype.navigate = function (appRouter) {
        var navigatingRouter = (this || _global).options.useAppRouter ? appRouter : (this || _global).router || appRouter;
        navigatingRouter.navigateToRoute((this || _global).route, (this || _global).params, (this || _global).options);
      };
    ...
    var buildRedirectPlan = function (instruction) {
      ...
      return router._createNavigationInstruction(config.redirect).then(function (redirectInstruction) {
        var params = {};
        ...
        for (var key in redirectInstructionParams) {
          ...
          if (typeof val === 'string' && val[0] === ':') {
            val = val.slice(1); // And if that param is found on the original instruction then use it
        ...
        var redirectLocation = router.generate(redirectInstruction.config, params, instruction.options); // Special handling for child routes
    ...
    var buildTransitionPlans = function (currentInstruction, previousInstruction, defaultViewPortConfigs, forceLifecycleMinimum) {
      ...
      var _loop_1 = function (viewPortName) {
        ...
        var newInstructionViewPortConfigs = newInstructionConfig.viewPorts; // if this is invoked on a viewport without any changes, based on new url,
        // newViewPortConfig will be the existing viewport instruction

        var nextViewPortConfig = viewPortName in newInstructionViewPortConfigs ? newInstructionViewPortConfigs[viewPortName] : prevViewPortInstruction;
        ...
        if (viewPortActivationStrategy !== "replace"
        /* Replace */
        && prevViewPortInstruction.childRouter) {
          var path = currentInstruction.getWildcardPath();

          var task = prevViewPortInstruction.childRouter._createNavigationInstruction(path, currentInstruction).then(function (childInstruction) {
            viewPortPlan.childNavigationInstruction = childInstruction;
            return _buildNavigationPlan(childInstruction, // is it safe to assume viewPortPlan has not been changed from previous assignment?
            ...
            viewPortPlan.strategy === "invoke-lifecycle"
            /* InvokeLifecycle */
              ...
              childInstruction.plan = childPlan; // for bluebird ?
    ...
    var determineActivationStrategy = function (currentNavInstruction, prevViewPortInstruction, newViewPortConfig, // indicates whether there is difference between old and new url params
    ...
    var loadNewRoute = function (routeLoader, navigationInstruction) {
      ...
      var loadPromises = loadingPlans.map(function (loadingPlan) {
        return loadRoute(routeLoader, loadingPlan.navigationInstruction, loadingPlan.viewPortPlan);
      });
    ...
    var loadRoute = function (routeLoader, navigationInstruction, viewPortPlan) {
      ...
      return loadComponent(routeLoader, navigationInstruction, planConfig).then(function (component) {
        var viewPortInstruction = navigationInstruction.addViewPortInstruction({
    ...
    var loadComponent = function (routeLoader, navigationInstruction, config) {
      ...
      return Promise.resolve().then(function () {
        return routeLoader.loadRoute(router, config, navigationInstruction);
      }).then(
      /**
      ...
      function (component) {
        ...
        if ('configureRouter' in viewModel) {
          ...
          return childRouter_1.configure(function (c) {
            return viewModel.configureRouter(c, childRouter_1, lifecycleArgs[0], lifecycleArgs[1], lifecycleArgs[2]);
          }).then(function () {
            return component;
          });
        }
    ...
    function () {
      function LoadRouteStep(routeLoader) {
        (this || _global).routeLoader = routeLoader;
      }
      /**@internal */
      ...
      LoadRouteStep.prototype.run = function (navigationInstruction, next) {
        return loadNewRoute((this || _global).routeLoader, navigationInstruction).then(next, next.cancel);
      };
        ...
        if (i < length) {
          try {
            ...
            return processPotential(result, function (val) {
              return inspect(val, current_1.router);
            }, next.cancel);
          } catch (error) {
            return next.cancel(error);
          }
    ...
    var findActivatable = function (navigationInstruction, callbackName, list, router) {
      ...
      var plan = navigationInstruction.plan;
      Object.keys(plan).forEach(function (viewPortName) {
        var viewPortPlan = plan[viewPortName];
    ...
    var SafeSubscription =
    /** @class */
    function () {
      function SafeSubscription(subscriptionFunc) {
        (this || _global)._subscribed = true;
        (this || _global)._subscription = subscriptionFunc(this || _global);

        if (!(this || _global)._subscribed) {
          this.unsubscribe();
        }
      }
      ...
      Object.defineProperty(SafeSubscription.prototype, "subscribed", {
        get: function () {
          return (this || _global)._subscribed;
        },
        enumerable: true,
        configurable: true
      });
      ...
      SafeSubscription.prototype.unsubscribe = function () {
        if ((this || _global)._subscribed && (this || _global)._subscription) {
          (this || _global)._subscription.unsubscribe();
        }

        (this || _global)._subscribed = false;
      };
    ...
    function () {
      function PipelineSlot(container, name, alias) {
        (this || _global).steps = [];
        (this || _global).container = container;
        (this || _global).slotName = name;
        (this || _global).slotAlias = alias;
      }

      PipelineSlot.prototype.getSteps = function () {
        var _this = this || _global;

        return (this || _global).steps.map(function (x) {
          return _this.container.get(x);
        });
      };
    ...
    function () {
      function PipelineProvider(container) {
        (this || _global).container = container;
        (this || _global).steps = [BuildNavigationPlanStep, CanDeactivatePreviousStep, LoadRouteStep, createPipelineSlot(container, "authorize"
        /* Authorize */
        ), CanActivateNextStep, createPipelineSlot(container, "preActivate"
        /* PreActivate */
        , 'modelbind'), // NOTE: app state changes start below - point of no return
        DeactivatePreviousStep, ActivateNextStep, createPipelineSlot(container, "preRender"
        /* PreRender */
        , 'precommit'), CommitChangesStep, createPipelineSlot(container, "postRender"
        /* PostRender */
        , 'postcomplete')];
      }
      /**@internal */
      ...
      PipelineProvider.inject = function () {
        return [aureliaDependencyInjection.Container];
      };
      /**
      ...
      PipelineProvider.prototype.createPipeline = function (useCanDeactivateStep) {
        ...
        if (useCanDeactivateStep === void 0) {
          useCanDeactivateStep = true;
        }

        var pipeline = new Pipeline();

        (this || _global).steps.forEach(function (step) {
      ...
      PipelineProvider.prototype._findStep = function (name) {
        ...
        return (this || _global).steps.find(function (x) {
      ...
      PipelineProvider.prototype.addStep = function (name, step) {
        ...
        if (found) {
          var slotSteps = found.steps; // prevent duplicates
    ...
    function (_super) {
      ...
      function AppRouter(container, history, pipelineProvider, events) {
        var _this = _super.call(this || _global, container, history) || this || _global;
      ...
      AppRouter.inject = function () {
        return [aureliaDependencyInjection.Container, aureliaHistory.History, PipelineProvider, aureliaEventAggregator.EventAggregator];
      };
      /**
       * Fully resets the router's internal state. Primarily used internally by the framework when multiple calls to setRoot are made.
       * Use with caution (actually, avoid using this). Do not use this to simply change your navigation model.
      ...
      AppRouter.prototype.reset = function () {
        _super.prototype.reset.call(this || _global);

        (this || _global).maxInstructionCount = 10;

        if (!(this || _global)._queue) {
          (this || _global)._queue = [];
        } else {
          (this || _global)._queue.length = 0;
        }
      };
      /**
      ...
      AppRouter.prototype.loadUrl = function (url) {
        ...
        return this._createNavigationInstruction(url).then(function (instruction) {
          return _this._queueInstruction(instruction);
      ...
      AppRouter.prototype.registerViewPort = function (viewPort, name) {
        var _this = this || _global; // having strong typing without changing public API


        var $viewPort = viewPort;

        _super.prototype.registerViewPort.call(this || _global, $viewPort, name); // beside adding viewport to the registry of this instance
        ...
        if (!(this || _global).isActive) {
          ...
          if ('configureRouter' in viewModel_1) {
            ...
            if (!(this || _global).isConfigured) {
              ...
              var resolveConfiguredPromise_1 = (this || _global)._resolveConfiguredPromise;

              (this || _global)._resolveConfiguredPromise = function () {};

              return this.configure(function (config) {
                return Promise.resolve(viewModel_1.configureRouter(config, _this)) // an issue with configure interface. Should be fixed there
      ...
      AppRouter.prototype.activate = function (options) {
        ...
        (this || _global).isActive = true; // route handler property is responsible for handling url change
        // the interface of aurelia-history isn't clear on this perspective

        (this || _global).options = Object.assign({
          routeHandler: (this || _global).loadUrl.bind(this || _global)
        }, (this || _global).options, options);

        (this || _global).history.activate((this || _global).options);
      ...
      AppRouter.prototype.deactivate = function () {
        ...
        (this || _global).history.deactivate();
      };
      /**@internal */
      ...
      AppRouter.prototype._dequeueInstruction = function (instructionCount) {
        ...
        return Promise.resolve().then(function () {
          ...
          if (!instructionCount) {
            _this.events.publish("router:navigation:processing"
            /* Processing */
            , {
          ...
          return pipeline.run(instruction).then(function (result) {
            return processResult(instruction, result, instructionCount, _this);
          }).catch(function (error) {
            return {
              output: error instanceof Error ? error : new Error(error)
            };
          }).then(function (result) {
            return resolveInstruction(instruction, result, !!instructionCount, _this);
          });
        });
      };
      /**@internal */
      ...
      AppRouter.prototype._findViewModel = function (viewPort) {
        if ((this || _global).container.viewModel) {
          return (this || _global).container.viewModel;
        }
        ...
        if (viewPort.container) {
          ...
          while (container) {
            if (container.viewModel) {
              (this || _global).container.viewModel = container.viewModel;
    ...
    var resolveInstruction = function (instruction, result, isInnerInstruction, router) {
      ...
      if (!isInnerInstruction) {
        ...
        eventAggregator.publish("router:navigation:child:complete"
        /* ChildComplete */
        , eventArgs);
      }
