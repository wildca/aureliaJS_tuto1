import { dew as _indexDewDew } from "aurelia-logging/index.dew.js";
import { dew as _indexDew2Dew } from "aurelia-dependency-injection/index.dew.js";
import { dew as _indexDew3Dew } from "aurelia-history/index.dew.js";
import { dew as _indexDew4Dew } from "aurelia-route-recognizer/index.dew.js";
import { dew as _indexDew5Dew } from "aurelia-event-aggregator/index.dew.js";
var exports = {},
    _dewExec = false;
export function dew() {
  ...
  var LogManager = _indexDewDew();

  var aureliaDependencyInjection = _indexDew2Dew();

  var aureliaHistory = _indexDew3Dew();

  var aureliaRouteRecognizer = _indexDew4Dew();

  var aureliaEventAggregator = _indexDew5Dew();
  /*! *****************************************************************************
  ...
  */
  ...
  function () {
    ...
    Router.prototype.createNavModel = function (config) {
      var navModel = new NavModel(this, 'href' in config ? config.href // potential error when config.route is a string[] ?
      : config.route);
  ...
  */
  ...
  function () {
    ...
    LoadRouteStep.prototype.run = function (navigationInstruction, next) {
      return loadNewRoute(this.routeLoader, navigationInstruction).then(next, next.cancel);
    };
  ...
  function () {
    function PipelineProvider(container) {
      this.container = container;
      this.steps = [BuildNavigationPlanStep, CanDeactivatePreviousStep, LoadRouteStep, createPipelineSlot(container, "authorize"
      /* Authorize */
  ...
  function (_super) {
    ...
    AppRouter.prototype.registerViewPort = function (viewPort, name) {
      var _this = this; // having strong typing without changing public API


      var $viewPort = viewPort;

      _super.prototype.registerViewPort.call(this, $viewPort, name); // beside adding viewport to the registry of this instance
    ...
    AppRouter.prototype.activate = function (options) {
      ...
      this.isActive = true; // route handler property is responsible for handling url change
